...
export function PricingCard({
  ...
  return (
    <div
      className={`relative rounded-2xl p-8 bg-white border-2 ${
        isPopular
    ...
    >
      {isPopular && (
        <div className="absolute -top-5 left-0 right-0 flex justify-center">
          <Badge className="bg-primary text-white px-4 py-1 rounded-full flex items-center gap-2">
            <Flame className="w-4 h-4" /> Mais popular
          </Badge>
        </div>
      )}
      <div className="mb-6">
